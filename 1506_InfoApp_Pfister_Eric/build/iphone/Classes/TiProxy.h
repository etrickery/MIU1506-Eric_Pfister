...
//Rare exceptions to indicate a bug in the _k1506_infoapp_pfister_eric code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1506_InfoApp_Pfister_Eric proxies.
 */
