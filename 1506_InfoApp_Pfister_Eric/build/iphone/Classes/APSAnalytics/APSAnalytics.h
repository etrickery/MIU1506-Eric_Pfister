 ...
 * to send analytic data that can be viewed on the k1506_InfoApp_Pfister_Eric Dashboard.
 *
 * For information on getting started with k1506_InfoApp_Pfister_Eric Platform Services,
