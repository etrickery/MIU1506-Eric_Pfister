...
@interface k1506_AboutMe_Pfister_EricObject : KrollCoverageObject {
#else
@interface k1506_AboutMe_Pfister_EricObject : KrollObject {
#endif
@private
...
extern NSString * k1506_AboutMe_Pfister_Eric$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1506_AboutMe_Pfister_EricObject *_k1506_aboutme_pfister_eric;
    KrollObject* console;
	BOOL shutdown;
