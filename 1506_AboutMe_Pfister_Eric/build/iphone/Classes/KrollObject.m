...
//@interface k1506_AboutMe_Pfister_EricObject : NSObject
//@end

@interface k1506_AboutMe_Pfister_EricObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1506_AboutMe_Pfister_EricObject class]])
		{
			for (NSString *key in [[(k1506_AboutMe_Pfister_EricObject*)o modules] allKeys])
			{
