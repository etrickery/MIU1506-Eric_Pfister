...
// in simulator we redefine to format for k1506_UtilityApp_Pfister_Eric Developer console
...
{\
	NSString * exceptionName = [@"org.k1506_utilityapp_pfister_eric." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1506_utilityapp_pfister_eric";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1506_UtilityApp_Pfister_EricNativeItemNone = -1, 
	UIk1506_UtilityApp_Pfister_EricNativeItemSpinner = -2,
	UIk1506_UtilityApp_Pfister_EricNativeItemProgressBar = -3,
	
	UIk1506_UtilityApp_Pfister_EricNativeItemSlider = -4,
	UIk1506_UtilityApp_Pfister_EricNativeItemSwitch = -5,
	UIk1506_UtilityApp_Pfister_EricNativeItemMultiButton = -6,
	UIk1506_UtilityApp_Pfister_EricNativeItemSegmented = -7,
	
	UIk1506_UtilityApp_Pfister_EricNativeItemTextView = -8,
	UIk1506_UtilityApp_Pfister_EricNativeItemTextField = -9,
	UIk1506_UtilityApp_Pfister_EricNativeItemSearchBar = -10,
	
	UIk1506_UtilityApp_Pfister_EricNativeItemPicker = -11,
	UIk1506_UtilityApp_Pfister_EricNativeItemDatePicker = -12,
	
	UIk1506_UtilityApp_Pfister_EricNativeItemInfoLight = -13,
	UIk1506_UtilityApp_Pfister_EricNativeItemInfoDark = -14,
	
	UIk1506_UtilityApp_Pfister_EricNativeItemDisclosure = -15,
	
	UIk1506_UtilityApp_Pfister_EricNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1506_UtilityApp_Pfister_Eric instances of
